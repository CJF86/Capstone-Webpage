...
if(isset($_POST['submit']))
{
    ...
    $LoginCommand = "SELECT * FROM user_table WHERE Username = '$name' AND Password = '$password'";
    $LoginUpdate = "UPDATE user_table SET loginStatus = '$IsloggedIn' WHERE Username = '$name' AND Password = '$password'";
    $NoLogin = "UPDATE user_table SET loginStatus = '$NotloggedIn' WHERE Username = '$name' AND Password = '$password'";
