...
if(isset($_POST['submit']))
{
    ...
    $DupCheck = "SELECT * FROM users WHERE Username = '$name' AND Password = '$password' AND Email = '$email'";
    ...
    {
        $insert = "INSERT INTO users (Username, Password, Email, CPassword) VALUES ('$name','$password','$email','$c_password')";
